# 객체지향 코드 연습 - 로또([우아한테크코스 프리코스 - view](https://github.com/woowacourse-precourse/java-lotto))
...
- 도메인 로직에 단위 테스트를 구현해야 한다. 단, UI(System.out, System.in, Scanner) 로직은 제외한다.
    ...
    - 단위 테스트 작성이 익숙하지 않다면 `test/java/view/LottoTest`를 참고하여 학습한 후 테스트를 구현한다.
...
- 미션은 [practice-oop-view](https://github.com/COW-edu/practice-oop-lotto) 저장소를 Fork & Clone해 시작한다.
